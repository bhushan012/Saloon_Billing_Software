        ...
        <div class="totalWithGenerateBill border border-right-0 border-left-0 border-bottom-0 pt-2" style="position: absolute;bottom: 10px;left: 0;right: 0;">
            <div class="row ">
                <div class="col-md-8">
                    ...
                    <p class="font-weight-bold pl-4 mb-0">Amount Paid</p>
                    <p class="font-weight-bold pl-4 mb-0">Credit</p>
                </div>
                <div class="col-md-4 text-center">
                    ...
                    <p class="mb-0" id="amntPaid">0</p>
                    <p class="mb-0" id="creditToPay">0</p>
                </div>
            </div>
